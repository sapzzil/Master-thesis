...
> 작성일: 2026-08-15 (1차) / 2026-09-23 (2차 공식 PDF 전수 대조 갱신)
> 작성자: 독립 검증 에이전트 (요약 작성 에이전트와 별개)
> 대상: `02_요약정리/하위갈래D_TSFM한계_실패분석.md`
> 원칙: 오직 공식 원본 PDF와 1:1 대조하여 실측치만 검증함.
>
> **★ 2026-09-23 2차 갱신 완료 사항**:
> 1. `Profit Mirage` (2510.07920, 사전학습 Look-ahead 누출 벤치마크) 공식 PDF 확인 및 하위갈래 D 리스크 3번 보강 편입.
> 2. `Re(Visiting)` (2511.18578, 138p PDF) 전수 대조: 글로벌 94개국 실증 중 한국 시장 실측치(p.74~76, 기본 샤프 0.45, 증강 후에도 < 1.0 극한의 시장) 및 Table D.2(14개 TSFM 코퍼스 내 주식 부재) 확인 완료.
> 3. `Pretrained TSFM` (2606.27100, 37p PDF) 전수 대조: Table 7 일측 Diebold-Mariano 검정 실측치(AMZN Chronos p=0.0421, GOOG Moirai-2.0 p=0.0421 외 나머지 8개 랜덤워크 기각 실패) 확인 완료.
> 4. 상세 검증 내용은 `02_요약정리/검증로그_공식PDF_2차전수대조.md` 참조.
