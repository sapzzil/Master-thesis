...
| **하위갈래 B**<br>(평가론) | - pinball loss CRPS 등가식 1차 출처 부재<br>- 금융 평가 벤치마크 문헌 부족 | - Moirai 부록 C.1을 1차 출처로 확정.<br>- **`FinTSB` (2502.18834, 중국 A주 20개 데이터셋 벤치마크 평가론)** 신규 발굴 및 본문 매핑 완료. [2026-09-23 27차 정정: 최초 매핑 당시 "18개/5대 자산군"으로 오기재되었던 것을 원문 재대조로 정정 — 실제는 A주 단일 자산군 20개 데이터셋. 상세: 하위갈래B 5-보강3.] | **전수 종결<br>(신규 편입)** |
